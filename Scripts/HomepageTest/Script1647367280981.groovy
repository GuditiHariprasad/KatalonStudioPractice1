...
WebUI.callTestCase(findTestCase('LoginpageTest'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Welcome Akshayjj'))
